...
<head>
    ...
    <link href="regulamin.css" rel="stylesheet">
</head>
<body>
  <div class="profile-icon container-fluid d-flex justify-content-end">
    <img src="img/img2/arrowsDown/profileIcon.svg" alt="">
  </div>
